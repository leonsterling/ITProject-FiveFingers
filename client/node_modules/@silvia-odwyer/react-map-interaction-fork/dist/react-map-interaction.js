  ...
  MapInteraction_createClass(MapInteractionControlled, null, [{
    ...
    get: function get() {
      return {
        ...
        zoomIn: external_commonjs_prop_types_commonjs2_prop_types_commonj2s_prop_types_amd_prop_types_root_PropTypes_default.a.number,
        disableZoom: external_commonjs_prop_types_commonjs2_prop_types_commonj2s_prop_types_amd_prop_types_root_PropTypes_default.a.bool,
  ...
  MapInteraction_createClass(MapInteractionControlled, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.zoomIn !== this.props.zoomIn) {
        if (prevProps.zoomIn < this.props.zoomIn) {
          this.zoomIntoImage();
        } else if (prevProps.zoomIn > this.props.zoomIn) {
          this.zoomOutOfImage();
        }
      }
    }
    ...
    */
    ...
    key: "zoomIntoImage",
    value: function zoomIntoImage(e) {
    ...
    key: "zoomOutOfImage",
    value: function zoomOutOfImage(e) {
    ...
    value: function discreteScaleStepSize() {
      var _this$props4 = this.props,
          ...
          maxScale = _this$props4.maxScale;
      var delta = Math.abs(maxScale - minScale);
      return delta / 10;
    ...
    value: function changeScale(delta) {
      ...
      var _this$props5 = this.props,
          minScale = _this$props5.minScale,
          maxScale = _this$props5.maxScale;
  ...
  MapInteraction_createClass(MapInteractionController, [{
    ...
    value: function innerProps() {
      var _this$props7 = this.props,
          ...
          innerProps = _objectWithoutProperties(_this$props7, ["value", "defaultValue", "onChange"]);
