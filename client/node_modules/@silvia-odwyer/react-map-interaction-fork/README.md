# react-map-interaction-fork

**NOTE:** This is a fork of the original react-map-interaction library, and implements additional features, namely:

- Zoom-in and zoom-out functionality upon zoom prop changes. 
